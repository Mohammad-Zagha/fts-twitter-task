  ...
  return (
    <div className="col-span-2 h-full flex justify-between flex-col bg-black border-r-2 border-[#191919]">
      <div className="flex flex-col gap-6">
        ...
        <SideBarItem icon={<IoSearchOutline size={26} />} text="Explore" />
        <SideBarItem
          icon={<RiNotification2Line size={26} />}
          text="Notifications"
        />
        <SideBarItem icon={<HiOutlineMail size={26} />} text="Messages" />
        <SideBarItem icon={<CiViewList size={26} />} text="List" />
        <SideBarItem icon={<CiBookmark size={26} />} text="Bookmarks" />
        <SideBarItem icon={<MdPeopleOutline size={26} />} text="Communities" />
        <SideBarItem icon={<IoPersonOutline size={26} />} text="Profile" />
        <SideBarItem icon={<CiCircleMore size={26} />} text="More" />
        <button className="text-white font-semibold py-2 bg-[#1C9BF0] rounded-full m-2">
          Post
        </button>
      </div>
      <SideBarFooter
...
const SideBarItem = ({ icon, text }) => {
  return (
    <div className="flex gap-2 items-center font-semibold  text-white px-2">
      {icon}
      {text}
    </div>
  );
